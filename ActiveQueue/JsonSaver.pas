...
type
  ...
  var
    ...
    /// name last used for saving a file. Used for eliminating some last copies.
    FLastUsedName: String;
...
var
  OutFileName: String;
  jo: TJsonObject;
  Text, FullPath, LastFullPath: String;
begin
  TMonitor.Enter(FLockObject);
  Try
